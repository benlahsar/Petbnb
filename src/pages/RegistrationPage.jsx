    ...
    <div className="min-h-screen flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:block lg:w-1/2 bg-emerald-800 relative">
        ...
        >
          ...
          <div className="absolute bottom-1/3 left-1/3 w-16 h-16 rounded-full bg-emerald-700 opacity-20"></div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold mb-2">
              Register to <span className="text-emerald-900">Petbnb</span>
            </h1>
